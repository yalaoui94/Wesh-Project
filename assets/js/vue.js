...
const Home = {
  ...
  methods: {
    ...
    addToCart(product) {
      ...
      //checker si le est présent dans le array (en mettre une boucle for pour eviter la repition)//
    ...
    // condition: (quand on retire une quantité qui sera égale à 0 automatiquement le produit sera retirer du panier)// 
